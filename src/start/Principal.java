...
public class Principal {
	...
	private void inicio() {
		...
		try {
			cfg = utils.Ficheros.cargarFicheroCFG();
		} catch (Exception e) {}
		...
		if (databasemanager.DBsqlServer.testConexion()) {
			...
			JOptionPane.showMessageDialog(null, "No se puede establecer la conexión con el servidor.", "ERROR DE CONEXION", JOptionPane.ERROR_MESSAGE);
		}
